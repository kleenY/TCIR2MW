...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='vit', help='vit or res_cnn selects model to use for netG')
        self.parser.add_argument('--n_layers_D', type=int, default=3, help='only used if which_model_netD==n_layers')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')

        self.parser.add_argument('--name', type=str, default='inf2mw', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--model', type=str, default='vit_one',
                                 help='chooses which model to use. vit_one')
        ...
        self.parser.add_argument('--display_winsize', type=int, default=300, help='display window size')
        ...
        self.parser.add_argument('--pre_trained_path', type=str,
                                 default='',help='path to the pre-trained resnet architecture')
